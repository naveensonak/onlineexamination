...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Online Examination || <?php echo(seocontent('title','2'));?></title>
  <meta name="description" content="<?php echo(seocontent('metadescription','2'));?>" />
  <meta name="keywords" content="<?php echo(seocontent('tag','2'));?>" />
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-6">
                        <div class="about-text">
                            <h2>Largest Question Bank</h2>
                            <?php echo(seocontent('content','2'));?>
