...
<div id="changepasword" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" class="modal fade">
  <div class="modal-dialog modal-sm">
    ...
    <input class="form-control" type="hidden" id="userid" name="userid" value="<?php echo $_SESSION['frontuserid']; ?>">
            <br />
            
            <div class="form-group">
              <div class="col-lg-offset-1 col-lg-12 text-center">
            <button type="submit" class="mb-sm btn btn-danger">Submit</button>
              </div>
            </div>
          </div>
        </form>
