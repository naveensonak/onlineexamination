...
<head>
    ...
    <title>Online Examination || Video Gallery</title>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-6">
                        <div class="about-text">
                            <h2>Video Gallery</h2><br>

                           <div class="row">
<?php
$detailresult = mysqli_query($config,"SELECT * FROM `gallery_video` where `status`='1' order by id desc");
