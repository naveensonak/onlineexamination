...
<head>
  ...
  <title>Adminsuit | Manage Questa</title>
...
<?php include("include/header.inc.php");?>
 ...
 <?php include("include/navigation.inc.php");?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Manage Questa</li>
      </ol>
    </section>
  ...
  $Query=mysqli_query($config,"select * from `tbl_questa`");
  $i=0; 
...
<script src="js/add_questacategory.js"></script> 
...
<div id="excel" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog modal-sm">
   ...
   <form name="questa" id="questa" enctype="multipart/form-data" action="#" method="post">
