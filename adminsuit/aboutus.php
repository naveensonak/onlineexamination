...
$sql= "UPDATE `seo_content` SET `content` = '$content',`title`='$title',`tag`='$tag',`metadescription`='$metadescription' WHERE `id`= '1'";
$query=mysqli_query($config,$sql);
if($query){
	
	header("location:aboutus.php?msg=updt");
...
<head>
  ...
  <title>Adminsuit | About Us</title>
...
<?php include("include/header.inc.php");?>
 ...
 $sql="select* FROM `seo_content` WHERE id='1'";
$query=mysqli_query($config,$sql);
