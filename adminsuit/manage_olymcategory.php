...
<head>
  ...
  <title>Adminsuit | Manage Olympiads</title>
 ...
 <?php include("include/navigation.inc.php");?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Manage  Olympiads</h1>
      <ol class="breadcrumb">
        <li><a href="desktop.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Manage Olympiads</li>
      </ol>
    </section>
  ...
  $Query=mysqli_query($config,"select * from `tbl_olympiads`");
  $i=0; 
...
<script src="js/add_olymcategory.js"></script> 
...
<div id="excel" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog modal-sm">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h4 class="modal-title" id="chn">Add Category</h4>
               
              </div>
   <form name="olympiads" id="olympiads" enctype="multipart/form-data" action="#" method="post">
              <div class="modal-body">
              <div class="form-group ">
                  <label for="uploadexcel">Add Category</label>  
