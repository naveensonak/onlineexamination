...
<?php include("include/header.inc.php");?>
 ...
 <?php include("include/navigation.inc.php");?> 
  ...
  $counter=mysqli_query($config,"select count(*) from `tbl_questaquestion` where `testid`='".$row["id"]."'");
                ...
                <tr>
                 <td><?php echo @$row["code"]; ?></td>
                  ...
                  <td style="font-style:italic;"><?php echo @$row["category"]; ?></td>
                   ...
                   <td><a href="manage_questaquestionDetail.php?id=<?php echo encryptor('encrypt', $row['id']); ?>" title="Manage Question"><i class="fa  fa-question-circle" style="color:#f56954; ;font-size:18px;"></i></a>&nbsp;&nbsp;&nbsp;
