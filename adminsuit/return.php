...
$sql= "UPDATE `content` SET `return` = '$content' WHERE `id`= '1'";
$query=mysqli_query($config,$sql);
if($query){
	
	header("location:return.php?msg=updt");
...
<head>
  ...
  <title>Adminsuit | Return and Refunds</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Return and Refunds</li>
      </ol>
    </section>
...
<label for="content">Return and Refunds</label>
<textarea id="content" class="ckeditor" name="content"><?php echo @$role["return"]; ?></textarea>
</div></div>
