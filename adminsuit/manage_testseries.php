...
<head>
  ...
  <title>Adminsuit | Manage Test Series</title>
...
<?php include("include/header.inc.php");?>
 ...
 <?php include("include/navigation.inc.php");?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Manage Test Series</li>
      </ol>
    </section>
  ...
  <a href="add_testseries.php" class="btn btn-block btn-danger">Add New</a>
       </div>
       </div>
            </div>
            <!-- /.box-header -->
  ...
  $Query=mysqli_query($config,"select *,(select `category` from `tbl_category` where `id`=`tbl_testseries`.`catid`)as category,(select `subcategory` from `tbl_subcategory` where `id`=`tbl_testseries`.`subcatid`)as subcategory from `tbl_testseries` order by id desc");
  $i=0; 
  while($row=mysqli_fetch_array($Query)){$i++;
   ?>   
                <tr>
                 
                  <td><?php echo @$row["seriesno"]; ?></td>
  ...
  <img class="img-circle img-bordered-sm" src="../<?php echo @$row["material"]; ?>">
                   ...
                   <td><a href="edit_testseries.php?id=<?php echo encryptor('encrypt', $row['id']); ?>" class="update-person" title="Edit"><i class="fa fa-edit" style="font-size:16px;"></i></a>&nbsp;&nbsp;&nbsp;
