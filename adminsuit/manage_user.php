...
<?php include("include/header.inc.php");?>
 ...
 ?></td>
              <td>
			  <a href="javascript:void(0);" onClick="ownerdetail(<?php echo $row['id']; ?>)" class="text-danger" style="font-size:16px;" title="User Detail" data-toggle="tooltip"><i class="fa fa-user"></i></a>
			  <?php 
	  if($row['status']==1){
	  ?>
      &nbsp;&nbsp;&nbsp;
      <a href="javascript:void(0);" onClick="Respond(<?php echo $row['id']; ?>)" class="update-person" style="color:#090; font-size:16px;" title="Active" data-toggle="tooltip"><i class="fa fa-check-square-o"></i></a>
      <?php } else if($row['status']==0){?>
      &nbsp;&nbsp;&nbsp;
      <a href="javascript:void(0);" onClick="UnRespond(<?php echo $row['id']; ?>)" class="update-person" style="color:#f00; font-size:16px;" title="Inactive" data-toggle="tooltip"><i class="fa fa-square-o"></i></a>
       <?php }?>
     
        &nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" onClick="delete_row(<?php echo $row['id'];?>)" class="update-person" style="color:#f56954; font-size:16px;" title="Delete" data-toggle="tooltip"><i class="fa fa-trash"></i></a> 
       </td>
                </tr>
        <?php }?>
