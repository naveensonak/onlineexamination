...
<head>
  ...
  <title>Adminsuit | Manage Question</title>
...
<?php include("include/header.inc.php");?>
 ...
 <?php include("include/navigation.inc.php");?> 
  ...
  $counter=mysqli_query($config,"select count(*) from `tbl_question` where `testid`='".$row["id"]."'");
   ...
   ?>   
                <tr>
                  ...
                  <td><?php echo ucfirst(@$row["type"]); ?></td>
                   ...
                   <td><a href="manage_questionDetail.php?id=<?php echo encryptor('encrypt', $row['id']); ?>" title="Manage Question"><i class="fa  fa-question-circle" style="color:#f56954; ;font-size:18px;"></i></a>&nbsp;&nbsp;&nbsp;
