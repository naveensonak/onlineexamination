...
<head>
  ...
  <title>Adminsuit | Manage Olympiads Question</title>
...
<?php include("include/header.inc.php");?>
 ...
 ?> 
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="manage_olymquestion.php"><i class="fa fa-question-circle"></i> Manage Olympiads Question</a></li>
        <li class="active">Manage Olympiads Question Detail</li>
      </ol>
    </section>
  ...
  $Query=mysqli_query($config,"select *,(select `code` from `tbl_olympiadstest` where `id`=`tbl_olymquestion`.`testid`)as code,(select `testname` from `tbl_olympiadstest` where `id`=`tbl_olymquestion`.`testid`)as testname from `tbl_olymquestion` where `testid`='".$id."' ");
  echo $num=mysqli_num_rows($Query);
   ?> </span>
   </div>
              <div class="col-sm-2">
              <div class="pull-right-btn">
  <a href="add_olymquestionDetail.php?testid=<?php echo @$_GET['id'];?>" class="btn btn-block btn-danger">Add New</a>
       </div>
       </div>
            </div>
            <!-- /.box-header -->
   ...
   ?>   
               ...
               <td><?php echo @$i; ?></td>
                  ...
                  <td><?php echo @$row["question"]; ?></td>
                   ...
                   <td><a href="edit_olymquestionDetail.php?id=<?php echo encryptor('encrypt', $row['id']);?>&testid=<?php echo @$_GET['id'];?>" class="update-person" title="Edit"><i class="fa fa-edit" style="font-size:16px;"></i></a>&nbsp;&nbsp;&nbsp;
