...
<head>
  ...
  <title>Adminsuit | Manage Photo Gallery</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Manage Photo Gallery</li>
      </ol>
    </section>
...
include('include/connect.php');
  ...
  $Query=mysqli_query($config,"select * from `gallery_photo` order by id desc");
  $i=0; 
...
<script src="js/add_galleryphoto.js"></script> 
  ...
  <div class="modal-dialog">
   ...
   <form name="type" id="type" enctype="multipart/form-data" action="#" method="post">
              ...
              <div class="form-group ">
                  <label for="uploadexcel">Title</label>  
   <input class="form-control" id="add_item" name="add_item"  type="text" required>
    <input class="form-control" id="editid" name="editid"  type="hidden">
          ...
          <div class="form-group ">
                  <label for="uploadexcel">Photo</label> 
   <input id="material" name="material"  type="file" required><span class="red_txt"> Use Photo size (W=500 x H =500)</span>
                </div>      
              </div>
