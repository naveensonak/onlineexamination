...
<head>
  ...
  <title>Adminsuit | Manage Demo Test Enquiry </title>
 ...
 <?php include("include/navigation.inc.php");?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Manage Demo Test Enquiry</h1>
      <ol class="breadcrumb">
        <li><a href="desktop.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Manage Demo Test Enquiry</li>
      </ol>
    </section>
  ...
  <!--<a href="add_demoTest.php" class="btn btn-block btn-danger">Add New</a>-->
       </div>
       </div>
            </div>
            <!-- /.box-header -->
  ...
  $Query=mysqli_query($config,"select *,(select `testname` from `tbl_demotest` where `id`= `tbl_demotestenquery`.`testid`)as testname from `tbl_demotestenquery` order by id desc");
  $i=0; 
