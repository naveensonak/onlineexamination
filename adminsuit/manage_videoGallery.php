...
<head>
  ...
  <title>Adminsuit | Manage Video Gallery</title>
...
include('include/connect.php');
  ...
  $Query=mysqli_query($config,"select * from `gallery_video` order by id desc");
  $i=0; 
...
<script src="js/add_galleryvideo.js"></script> 
  ...
  <div class="modal-dialog">
   ...
   <input class="form-control" id="add_item" name="add_item"  type="text" required>
    <input class="form-control" id="editid" name="editid"  type="hidden">
          ...
          <div class="form-group ">
                  <label for="uploadexcel">Video Code</label> 
