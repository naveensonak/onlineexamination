...
$sql= "UPDATE `seo_content` SET `shortdes`='$short',`content` = '$content',`title`='$title',`tag`='$tag',`metadescription`='$metadescription' WHERE `id`= '3'";
$query=mysqli_query($config,$sql);
if($query){
	
	header("location:analysis.php?msg=updt");
...
<head>
  ...
  <title>Adminsuit | Analysis</title>
...
<?php include ("include/header.inc.php");?>
 ...
 $sql="select* FROM `seo_content` WHERE id='3'";
$query=mysqli_query($config,$sql);
...
<label for="content">Analysis</label>
