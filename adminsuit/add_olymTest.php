...
<head>
  ...
  <title>Adminsuit | <?php if(@$_GET['id']!=''){echo "Edit";}else{echo "Add";} ?> Olympiads Test </title>
...
$role=mysqli_fetch_array($query);
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1><?php if(@$_GET['id']!=''){echo "Edit";}else{echo "Add";} ?> Olympiads Test </h1>
      <ol class="breadcrumb">
   <li><a href="manage_olymtest.php"><i class="fa fa-dashboard"></i> Manage Olympiads Test </a></li>
  <li class="active"><?php if(@$_GET['id']!=''){echo "Edit";}else{echo "Add";} ?> Olympiads Test </li>
      </ol>
    </section>
   ...
   <form id="addolymtestform" name="formID" method="post" action="#" enctype="multipart/form-data">
      <div class="col-sm-10 col-xs-offset-1">
          ...
          <option value="" selected>Select a category</option>
                  <?php 
$sql_query_status11=mysqli_query($config,"select * from `tbl_olympiads` where `status`='1'");
...
<input class="form-control datepicker" id="startdate" name="startdate" type="text" value="" >
                </div>
                </div>-->
                <!--<div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="form-group">
                  <label for="enddate">End Date  :<span>*</span></label>
<input class="form-control datepicker" id="enddate" name="enddate" type="text" value="" >
                </div>
                </div>-->
                <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="form-group">
...
<textarea name="shortdes" id="shortdes"  class="form-control" maxlength="150"></textarea>
 ...
 <textarea id="about" name="about" class="ckeditor"></textarea>
                </div>
                </div>            
             <div class="clearfix"></div> 
...
<script type="text/javascript" src="js/add_olymtest.js"></script>
