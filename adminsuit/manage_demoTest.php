...
<head>
  ...
  <title>Adminsuit | Manage Demo Test </title>
...
<?php include("include/header.inc.php");?>
 ...
 <?php include("include/navigation.inc.php");?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Manage Demo Test</li>
      </ol>
    </section>
  ...
  <img class="img-circle img-bordered-sm" src="../<?php echo @$row["material"]; ?>">
                   ...
                   <td><a href="edit_demoTest.php?id=<?php echo encryptor('encrypt', $row['id']); ?>" class="update-person" title="Edit"><i class="fa fa-edit" style="font-size:16px;"></i></a>&nbsp;&nbsp;&nbsp;
