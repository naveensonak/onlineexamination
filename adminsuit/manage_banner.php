...
<?php include("include/header.inc.php");?>
 ...
 <?php include("include/navigation.inc.php");?> 
  ...
  $Query=mysqli_query($config,"select * from `banner` order by id desc");
  $i=0; 
...
<div id="excel" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
        ...
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <h4 class="modal-title" id="chn">Add Banner</h4>
   ...
   <input class="form-control" id="add_item" name="add_item"  type="text" required>
    <input class="form-control" id="editid" name="editid"  type="hidden">
     ...
     <div class="form-group ">
                  <label for="sd">Add Small Description</label>  
   <input class="form-control" id="sd" name="sd"  type="text" required>
    
                </div> 
                <div class="form-group ">
                  <label for="sd">Add Link</label>  
   <input class="form-control" id="link" name="link"  type="text" required>
    
                </div>         
          <div class="form-group ">
                  <label for="uploadexcel">Images</label> 
   <input id="material" name="material"  type="file" required><span class="red_txt"> Use Photo size (W=1920 x H =750)</span>
                </div>      
              </div>
