...
$sql="SELECT * FROM `tbl_questionbank` where id=$id";
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?php if(@$_GET['id']!=''){echo "Edit";}else{echo "Add";} ?> Question Bank</li>
      </ol>
    </section>
...
$sql_query_status11=mysqli_query($config,"select * from `tbl_subcategory` where `catid`='4' and `status`='1'");
  while($row_query_status11=mysqli_fetch_array($sql_query_status11)) {?>
   <option <?php if(@$role['subcatid']==$row_query_status11['id']) {echo "selected='selected'";} ?> value="<?php echo $row_query_status11['id']?>" >
   ...
   <input class="form-control" id="seriesno" name="seriesno" type="text" value="<?php echo @$role['qbid'];?>" >
                </div>
                </div>
   ...
   <input class="form-control" id="title" name="title" type="text" value="<?php echo @$role['qbname'];?>" >
                </div>
                </div>
   ...
   <input class="form-control" id="price" name="price" type="text"  value="<?php echo @$role['price'];?>" >
         ...
         <input  id="pdf" name="pdf" type="file" value="" accept=".pdf" >
                </div>
                </div>
