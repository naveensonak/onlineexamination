...
<head>
  ...
  <title>Adminsuit | Manage Olympiads Test </title>
 ...
 <?php include("include/navigation.inc.php");?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Manage Olympiads Test</h1>
      <ol class="breadcrumb">
        <li><a href="desktop.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Manage Olympiads Test</li>
      </ol>
    </section>
  ...
  <a href="add_olymTest.php" class="btn btn-block btn-danger">Add New</a>
       </div>
       </div>
            </div>
            <!-- /.box-header -->
  ...
  $Query=mysqli_query($config,"select *,(select `category` from `tbl_olympiads` WHERE `id`=`tbl_olympiadstest`.`catid`)as category from `tbl_olympiadstest` order by id desc");
  $i=0; 
 ...
 $convert2=date('d-m-Y',$post_date2);
  ...
  <img class="img-circle img-bordered-sm" src="../<?php echo @$row["material"]; ?>">
                  ...
                  <td><?php echo @$row["category"]; ?></td>
                   <td><a href="edit_olymtest.php?id=<?php echo encryptor('encrypt', $row['id']); ?>" class="update-person" title="Edit"><i class="fa fa-edit" style="font-size:20px;"></i></a>&nbsp;&nbsp;&nbsp;
                   <a href="manage_olymtimeSlot.php?id=<?php echo encryptor('encrypt', $row['id']); ?>" class="update-person" title="Add Slot"><i class="fa fa-clock-o" style="font-size:22px; color:#2B2BFF;"></i></a>&nbsp;&nbsp;&nbsp;
