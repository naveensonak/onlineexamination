...
<?php include("include/header.inc.php");?>
 ...
 ?> 
  ...
  $Query=mysqli_query($config,"select *,(select `code` from `tbl_test` where `id`=`tbl_question`.`testid`)as code from `tbl_question` where `testid`='".$id."' ");
  echo $num=mysqli_num_rows($Query);
   ?> </span>
   </div>
              <div class="col-sm-2">
              <div class="pull-right-btn">
  <a href="add_questionDetail.php?testid=<?php echo @$_GET['id'];?>" class="btn btn-block btn-danger">Add New</a>
       </div>
       </div>
            </div>
            <!-- /.box-header -->
   ...
   ?>   
               ...
               <td><?php echo @$i; ?></td>
                  ...
                  <td><?php echo @$row["question"]; ?></td>
                   ...
                   <td><a href="edit_questionDetail.php?id=<?php echo encryptor('encrypt', $row['id']);?>&testid=<?php echo @$_GET['id'];?>" class="update-person" title="Edit"><i class="fa fa-edit" style="font-size:16px;"></i></a>&nbsp;&nbsp;&nbsp;
