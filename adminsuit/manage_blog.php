...
<head>
  ...
  <title>Adminsuit | Manage News</title>
...
<?php include("include/header.inc.php");?>
 ...
 <?php include("include/navigation.inc.php");?> 
  ...
  $Query=mysqli_query($config,"select * from `blog_content` order by id desc");
  $i=0; 
  ...
  <img class="img-circle img-bordered-sm" src="../<?php echo @$row["material"]; ?>">
			  ...
			  <td>
			  <a href="edit_blog.php?id=<?php echo encryptor('encrypt', $row['id']); ?>" class="update-person" data-toggle="tooltip" title="Edit"><i class="fa fa-edit" style="font-size:16px;"></i></a>&nbsp;&nbsp;&nbsp;
