 ...
 ?> 
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Manage Demo Test Question Detail </h1>
      <ol class="breadcrumb">
        <li><a href="desktop.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="manage_Demoquestion.php"><i class="fa fa-question-circle"></i> Manage Demo Test Question</a></li>
        <li class="active">Manage Question Detail</li>
      </ol>
    </section>
  ...
  $Query=mysqli_query($config,"select *,(select `testname` from `tbl_demotest` where `id`=`tbl_demotestquestion`.`testid`)as code from `tbl_demotestquestion` where `testid`='".$id."' ");
  echo $num=mysqli_num_rows($Query);
   ?> </span>
   </div>
              <div class="col-sm-2">
              <div class="pull-right-btn">
  <a href="add_demoquestionDetail.php?testid=<?php echo @$_GET['id'];?>" class="btn btn-block btn-danger">Add New</a>
       </div>
       </div>
            </div>
            <!-- /.box-header -->
   ...
   ?>   
               ...
               <td><?php echo @$i; ?></td>
                  ...
                  <td><?php echo @$row["question"]; ?></td>
                   ...
                   <td><a href="edit_DemoquestionDetail.php?id=<?php echo encryptor('encrypt', $row['id']);?>&testid=<?php echo @$_GET['id'];?>" class="update-person" title="Edit"><i class="fa fa-edit" style="font-size:16px;"></i></a>&nbsp;&nbsp;&nbsp;
