...
<head>
  ...
  <title>Adminsuit | Manage Email Template</title>
 ...
 <?php include("include/navigation.inc.php");?> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <!--<a href="add_blog.php" class="btn btn-info">Add New</a>-->
  ...
  $Query=mysqli_query($config,"select * from `mailer` where  status='1'");
  $i=0; 
  while($row=mysqli_fetch_array($Query)){$i++;?>
			  ...
			  <td>
			  <a href="edit_emailtemplate.php?id=<?php echo encryptor('encrypt', $row['id']); ?>" class="update-person" data-toggle="tooltip" title="Edit"><i class="fa fa-edit" style="font-size:16px;"></i></a></td>
                </tr>
        <?php }?>
