...
$sql= "UPDATE `seo_content` SET `shortdes`='$short',`content` = '$content',`title`='$title',`tag`='$tag',`metadescription`='$metadescription' WHERE `id`= '2'";
$query=mysqli_query($config,$sql);
if($query){
	
	header("location:question-bank.php?msg=updt");
...
<head>
  ...
  <title>Adminsuit | Largest Question Bank</title>
...
<?php include('include/connect.php');//include("include/header.inc.php");?>
 ...
 $sql="select* FROM `seo_content` WHERE id='2'";
$query=mysqli_query($config,$sql);
 ...
 ?> 
  <div class="content-wrapper">
    <section class="content-header">
      <h1>Largest Question Bank</h1>
      <ol class="breadcrumb">
        <li><a href="desktop.php"><i class="fa fa-dashboard"></i>Home</a></li>
        <li class="active">Largest Question Bank</li>
      </ol>
    </section>
...
<label for="content">Largest Question Bank</label>
