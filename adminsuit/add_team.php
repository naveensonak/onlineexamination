...
$des1="../onlinetestseries/$new_file_name1";
 $des="onlinetestseries/$new_file_name1";
...
if(move_uploaded_file($path,$des1))	
 ...
 $sql= "INSERT INTO `team`(name,desig,about,material,title,tag,metadescription,status) VALUES ('". $title ."','".$short."','". $detail ."','".$des."','".$metatitle."','".$tag."','".$metadescription."','1')";
$query=mysqli_query($config,$sql);
if($query){
	header("location:add_team.php?msg=updt");
	}exit();
...
$role=mysql_fetch_array($query);
  ...
  <div class="content-wrapper">
   ...
   <textarea name="short" id="short"  class="form-control" style="resize:none;" maxlength="150" required></textarea>
                </div>
                </div>
            <div class="col-md-12 col-sm-6 col-xs-12">
                  <div class="form-group">
