...
$sql= "UPDATE `seo_content` SET `shortdes`='$short',`content` = '$content',`title`='$title',`tag`='$tag',`metadescription`='$metadescription' WHERE `id`= '5'";
$query=mysqli_query($config,$sql);
if($query){
	
	header("location:expert-recommendation.php?msg=updt");
...
<head>
  ...
  <title>Adminsuit | Expert Recommendations</title>
...
<?php include("include/header.inc.php");?>
 ...
 $sql="select* FROM `seo_content` WHERE id='5'";
$query=mysqli_query($config,$sql);
  ...
  <div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Expert Recommendations</li>
      </ol>
    </section>
...
<label for="content">Expert Recommendations</label>
