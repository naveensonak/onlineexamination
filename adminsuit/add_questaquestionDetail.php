...
<head>
  ...
  <title>Adminsuit | <?php if(@$_GET['id']!=''){echo "Edit";}else{echo "Add";} ?> Questa Question Detail</title>
...
if(@$testid=encryptor('decrypt', $_GET['testid'])){
  ...
  <div class="content-wrapper">
    ...
    <h1><?php if(@$_GET['id']!=''){echo "Edit";}else{echo "Add";} ?> Questa Question Detail</h1>
      <ol class="breadcrumb">
        <li><a href="manage_questaquestionDetail.php?id=<?php echo @$_GET['testid']?>"><i class="fa fa-dashboard"></i> Manage Question Detail</a></li>
        <li class="active"><?php if(@$_GET['id']!=''){echo "Edit";}else{echo "Add";} ?> Questa Question Detail</li>
      </ol>
    </section>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
         <?php
         include("include/connect.php");
  $Query=mysqli_query($config,"select *,(select `code` from `tbl_questatest` where `id`='".$testid."')as code from `tbl_questaquestion` where `testid`='".$testid."' ");
...
<textarea name="opt4" id="opt4"  class="ckeditor"></textarea>
 ...
 $Query2=mysqli_query($config,"select `totalquestion` from `tbl_questatest` where `id`='".$testid."' ");
...
<script type="text/javascript" src="js/add_questaquestionDetail.js"></script>
