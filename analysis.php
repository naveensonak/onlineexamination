...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Online Examination || <?php echo(seocontent('title','3'));?></title>
      <meta name="description" content="<?php echo(seocontent('metadescription','3'));?>" />
  <meta name="keywords" content="<?php echo(seocontent('tag','3'));?>" />
