...
<div class="about-lectures">
 ...
 <p><b>Duration:</b> <?php echo $testresult['duration'];?> Minute</p>
          ...
          <p class="text-center"> <a class="button extra-small button-blue " href="question-start.php?testid=<?php echo encryptor('encrypt',$testresult['id']);?>" onclick="RemoveCookie('my_cookie');"><span>Start Test</span></a></p>
                            </div>
