...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Online Examination || <?php echo(seocontent('title','4'));?></title>
      <meta name="description" content="<?php echo(seocontent('metadescription','4'));?>" />
  <meta name="keywords" content="<?php echo(seocontent('tag','4'));?>" />
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-6">
                        <div class="about-text">
                            <h2>Manage Time Effectively</h2>
                            <?php echo(seocontent('content','4'));?>
