...
$selecttest=mysqli_query($config,"select * from `tbl_questatest` where `id`='".$_GET['questaid']."'");
...
<a class="button extra-small button-blue" href="account.php?questa=<?php echo $selectresult['id'];?>"><span> Buy This Test </span></a>
<!--<a class="button extra-small button-black" href="account.php?seriesid=<?php echo $selectresult['id'];?>"><span> Demo Test </span></a>-->

<?php }else{?>
<a class="button extra-small button-blue" href="free.php?questa=<?php echo encryptor('encrypt',@$selectresult['id']);?>"><span> Buy This Test </span></a>
...
<?php } }else{
    if($selectresult['price'] > 0){?>
<h3>&#x20B9; <?php echo $selectresult['price'];?>.00</h3>
<?php if(@$_SESSION['frontuserid']==''){?>
<a class="button extra-small button-blue" href="questa_register.php?questa=<?php echo $selectresult['id'];?>"><span> Buy This Test </span></a>
<?php }else{?>
<a class="button extra-small button-blue" href="questa-order-details.php?questa=<?php echo encryptor('encrypt',@$selectresult['id']);?>"><span> Buy This Test </span></a>
<?php }} else{?>
    <a class="button extra-small button-blue" href="subscribeTest.php?questa=<?php echo encryptor('encrypt',@$selectresult['id']);?>"><span> Subscribe This Test </span></a>
<?php }}?>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-3 col-sm-4">
                        <div class="course-sidebar mrg-xs">
                            <?php include("include/questa_menu.php");?>
                            <?php include("include/latest_questa.php");?>
                        </div>
                    </div>
                </div>
            </div>
