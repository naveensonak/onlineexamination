...
$id=encryptor('decrypt',@$_GET['qbankid']);
$selecttest=mysqli_query($config,"select * from `tbl_questionbank` where `id`='".$id."'");
...
<h4><?php echo $selectresult['qbname'];?> 
...
<form action="<?php echo $action; ?>" method="post" name="payuForm">
 ...
 <input type="hidden" name="key" value="<?php echo $MERCHANT_KEY ?>" />
      ...
      <input type="hidden" name="txnid" value="<?php echo $txnid ?>" />
         ...
         <input type="hidden" name="udf1" value="qb" />
...
<input type="hidden" name="type" id="type"  value="qb"/>
