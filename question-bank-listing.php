...
$sql = "SELECT * FROM `tbl_questionbank` where `status`='1' and `catid`='".$catid."' and `subcatid`='".$courseid."' LIMIT $start_from, $num_rec_per_page";
...
<a href="question-bank-details.php?qbankid=<?php echo $row['id'];?>"><img src="<?php echo $row['material'];?>" alt="<?php echo $row['qbname'];?>" width="358" height="197"></a>
                            <div class="single-coures-text">
                                <h3><a href="question-bank-details.php?qbankid=<?php echo $row['id'];?>"><?php echo $row['qbname'];?></a></h3>
                                <p><?php echo $row['shortdes'];?></p>
                                
   <a href="question-bank-details.php?qbankid=<?php echo $row['id'];?>">READ MORE</a>
                            </div>
                        </div>
                    </div>
                    <?php }}?>
