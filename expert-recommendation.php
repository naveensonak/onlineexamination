...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title>Online Examination || <?php echo(seocontent('title','5'));?></title>
      <meta name="description" content="<?php echo(seocontent('metadescription','5'));?>" />
  <meta name="keywords" content="<?php echo(seocontent('tag','5'));?>" />
